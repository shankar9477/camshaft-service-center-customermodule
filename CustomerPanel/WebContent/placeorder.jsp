<%@page import="com.deo.CustomerRegistrationdeo"%>
<%@page import="com.deo.CustomerLogindeo"%>
<html lang="en">
<head>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<div id="home" class="w3ls-banner ">
		...
		<!-- banner-text -->
		<%@ page
			import="com.bean.Customerbean,com.bean.Placeorderbean,com.deo.CustomerLogindeo,com.deo.Placeorderdeo, com.servlet.CustomerLoginServlet,com.servlet.PlaceorderServlet, java.io.*"%>
		<%
			int custid = ((Integer) request.getAttribute("custid")).intValue();
			request.setAttribute("custid", custid);
			Customerbean cust = CustomerRegistrationdeo.getUsername(custid);
		%>
						...
						<div id="register" class="login-form ">
							<div class="agile-row">
								<div class="row">
									<div class="col-md-6">
										<button type="button"
											onclick="window.location.href='register.jsp'">Edit
											Profile</button>
									</div>
									<div class="col-md-6">
										<div class="rightside">
											<lable><%=request.getAttribute("username")%></lable>
											<button type="button" value="logout">Logout</button>
										</div>
									</div>
								</div>
								<br> <br>
								<h5>Place Your Work Order</h5>
								<div class="name-and-date">
									<div class="row">
										<div class="col-md-6">
											<label><%=cust.getCustname()%></label>
										</div>
										<div class="col-md-6" align="right">
											...
											<%-- <label><%=date%></label> --%>
											<%
												//custorder.setCustorderdate(date);
											%>
								...
								<div class="login-agileits-top">
									<form action="PlaceorderServlet" method="post">
										...
										<select name="services" id="service">
											<option value="">--Select--</option>
											<option value="fullcheckup">Full Check up</option>
											<option value="oilandfilterchange">Oil and filter
												change</option>
											<option value="wheelcheckupedes">Wheel check up</option>
